...
import { plainPrefixRule, allomorphRules, plainSuffixRule } from "./maduraStemmingRules";

export class StemmerMadura {
    private maduraDict = new RootWordDictionary(kataDasarMadura)
    ...
    private setData(word: string): StemResult {
        const context = new Context(word, this.maduraDict)
